            ...
            for conta in contas_origem:
                ...
                if nome_banco_origem == nome_banco:  # Mesma instituição
                    if banco.preparar(cpf_origem, numero_origem, valor):
                        transacoes_preparadas.append((nome_banco_origem,cpf_origem, numero_origem, valor))
...
def criar_conta_inicial():
    conta1 = banco.criar_contaPF('111', 100, '111', '111')
    conta2 = banco.criar_contaPF('000', 100, '000', '000')
    conta2 = banco.criar_contaPF('333', 100, '333', '333')
    conta_conjunta = banco.criar_contaConjunta('2222',100,'222','111','222')
    conta3 = banco.criar_contaPF('444', 100, '444', '444')
    conta4 = banco.criar_contaPF('555', 100, '555', '555')
